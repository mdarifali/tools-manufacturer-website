...
const NavBar = () => {
    ...
    return (
        <div className="navbar bg-yellow-200 px-12 fixed top-0 inset-x-0 z-50 mb-10">
            <div className="navbar-start">
                ...
                <Link to='/home' className="btn btn-ghost text-primary font-bold text-2xl">Car Parts</Link>
            </div>
