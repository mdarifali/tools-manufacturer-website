...
const GeneralQuestions = () => {
    return (
        <div className='my-10 p-10'>
            <div className="card lg:card-side bg-base-200 shadow-xl gap-5 flex">
                <figure className='flex-1'>
                    <img src={FAQ} alt="Album" />
                </figure>
                <div className="card-body flex-1 justify-center">
                    <div className="collapse collapse-plus border border-base-300 bg-base-300 rounded-box">
                        <input type="checkbox" className="peer" />
                        <div className="collapse-title">
                            Do you use the latest and best in infrastructure and technology?
                        </div>
                        <div className="collapse-content bg-green-400">
